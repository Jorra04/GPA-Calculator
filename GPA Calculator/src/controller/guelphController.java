...
//			System.out.println(gradesPane.getChildren());
			...
			writer.write("============================================\n");
			writer.write("Guelph GPA: " + finalGpa.getText());
...
//		System.out.println(parser);
		if ( parser == 0.5 || parser == 0.25 || parser == 0 || parser == 1 || parser == 0.75 ) {
			return true;
		}
		return false;
	}
...
//			System.out.println(Double.parseDouble(tf.getText()));
			...
			application.alert.display("Error", "Problem2");
			return;
		}
	}
